...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'color':'#503D36', 'font-size':24, 'textAlign':'center'}),#Include style for title
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
            names='Vehicle_Type',
            title='Advertising Expenditure by Type in the year {}'.format(input_year)))
